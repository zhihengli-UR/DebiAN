...
from scene_exp.scene_args import get_parser, parse_and_check
from common.constants import EPS
from scene_exp.base_trainer import BaseSceneTrainer


class Trainer(BaseSceneTrainer):
        ...
        for idx, (main_data, second_data) in enumerate(pbar):
            ...
            with torch.cuda.amp.autocast(self.args.amp):
                ...
                for target_val in range(self.num_classes):
                    ...
                    sum_penalty += penalty
                    num_classees_in_batch += 1

                sum_penalty *= self.args.lambda_penalty / num_classees_in_batch
                sum_discover_net_deo_loss /= num_classees_in_batch
