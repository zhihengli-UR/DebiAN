...
dset_name_lst = ['places', 'lsun']


def get_parser():
    parser = argparse.ArgumentParser()
    parser.add_argument('--dset_dir', default='data', type=str)
    parser.add_argument('--dset_name', type=str, required=True, choices=dset_name_lst)
    parser.add_argument('--ood_dset_name', type=str, required=True)
...
def parse_and_check(parser, required_args=None):
    ...
    assert args.ood_dset_name != args.dset_name
