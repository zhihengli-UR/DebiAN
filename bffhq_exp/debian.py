...
from bffhq_exp.args_bffhq import get_parser, parse_and_check
...
from bffhq_exp.base_trainer import BaseTrainer
    ...
    def train(self, epoch):
        ...
        for idx, (main_data, second_data) in enumerate(pbar):
            ...
            with torch.cuda.amp.autocast(enabled=self.args.amp):
                ...
                with torch.cuda.amp.autocast(enabled=False):
                    ...
                    for target_val in range(2):
                        ...
                        # if self.args.add_one_to_weight:
                        weight += 1
            ...
            pbar.set_description(
                "[{}/{}] ce: {:.3f}, l_dis: {:.3f}, deo: {:.3f}, penalty: {:.3f}".format(
                    epoch,
                    self.total_epoch,
                    avg_ce_loss,
...
if __name__ == "__main__":
    parser = get_parser()
    parser.add_argument(
        "--ckpt_dir", type=str, default="exp/bffhq"
    )
